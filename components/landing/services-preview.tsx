    ...
    <section className="px-6 py-20 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">Siding services built for lasting curb appeal</h2>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {servicesData.map((service) => (
            <Card key={service.slug} className="group overflow-hidden border-slate-200/80 bg-white/95 transition hover:-translate-y-1 hover:shadow-2xl">
              ...
              <div className="mt-6">
                <Link href={`/services/${service.slug}`}>
                  <Button variant="ghost" className="text-cyan-500 hover:bg-slate-100">
                    Learn more
                  </Button>
                </Link>
              </div>
